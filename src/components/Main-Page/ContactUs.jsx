  ...
  return (
    ...
    >
      <div id='ContactContent' className=' pt-5 ps-5 pe-5'>
        <h1 id='hcontact' className='pb-4' align='center'>
          Contact Us
        </h1>
        <p
          className='m-5'
          ...
          style={
            theme === '#ffffff7a'
              ? { color: '#282528', fontSize: '1.5rem', transition: 'all 0.6s' }
              : { color: 'white', fontSize: '1.5rem', transition: 'all 0.6s' }
          }
        >
            ...
            <Col>
              <div>
                <h2>
                  <BiMapPin
                    id='bima'
                    className='w-25 h-25  rounded-circle p-2 '
                  />
                </h2>
                ...
                <h5
                  style={
                    theme === '#ffffff7a'
                      ? { color: '#282528', transition: 'all 0.6s' }
                      : { color: '#F98221', transition: 'all 0.6s' }
                  }
                >
                  6421 N Tierra de las Catalinas, Tucson,AZ 85718
                </h5>
              </div>
            </Col>
            <Col>
